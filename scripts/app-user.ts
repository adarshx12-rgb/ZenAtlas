...
try{
 await db.transaction(async tx=>{
   ...
   await tx.query('GRANT SELECT,INSERT,UPDATE,DELETE ON sources,source_alternatives,source_health_events,content,content_removals,transcript_segments,moments,jobs,searches,feedback,provider_health,budgets TO search_app');
