...
export const testConfig=configSchema.parse({DATABASE_URL:'test',SESSION_SECRET:'test-session-secret-32-characters-long',ADMIN_TOKEN:'test-admin-token-32-characters-long'});
