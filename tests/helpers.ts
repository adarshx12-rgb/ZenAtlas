...
export const testConfig=configSchema.parse({DATABASE_URL:'test',SESSION_SECRET:'test-session-secret-32-characters-long',ADMIN_TOKEN:'test-admin-token-32-characters-long',REDDIT_SIGNALS:'false',PAGE_CHECKS:'0',ANILIST_ENABLED:'false',ARCHIVE_DISCOVERY:'false',SPECIALIST_SEARCHES:0});
